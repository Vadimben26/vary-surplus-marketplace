  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-square rounded-xl overflow-hidden bg-muted mb-3">
        ...
        {/* New badge */}
        {isNew && (
          <span className="absolute top-3 left-3 px-2.5 py-1 rounded-md text-xs font-semibold bg-primary text-primary-foreground">
            Nouveau
          </span>
        )}
      </div>
      ...
      <div className="space-y-1">
        ...
        <div className="pt-1">
          ...
          {pricePerUnit && (
            <span className="text-xs text-muted-foreground ml-1">({pricePerUnit}/u)</span>
          )}
        </div>
      </div>
    </motion.div>
